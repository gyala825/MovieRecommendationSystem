            ...
            function randomFrom(lowerValue,upperValue)
{
	...
	//console.log('result point 1');
        ...
        const path = '/user/hadoop/input_spark';
        //调用Spark程序为用户推荐电影并把推荐结果写入数据库
        let spark_submit = spawnSync('/usr/local/spark/bin/spark-submit',['--class', 'recommend.MovieLensALS',' ~/IdeaProjects/film_recommend_df/out/artifacts/film_recommend_df_jar/film_recommend_df.jar', path, userid],{ shell:true, encoding: 'utf8' });
